...
Practice with stack data structure, understanding polymorphism

Note: we do not need to create our own stack implementation, we can simply use the one supported by Python
"""
